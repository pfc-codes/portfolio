  ...
  return `
    <div class="lab-page">
      <header class="lab-header">
        <span class="lab-kicker">Experiments</span>
        <h1 class="lab-title">${lab.heading}</h1>
        ...
        ${experiments.map(exp => `
          <article class="specimen-card" data-experiment="${exp.id}" tabindex="0" role="button" aria-label="View ${exp.title}">
            <div class="specimen-media">
              <div class="specimen-media-placeholder">${exp.id.toUpperCase()}</div>
            </div>
  ...
  return `
    <div class="experiment-detail">
      <div class="experiment-media">
        <div class="specimen-media-placeholder">${experiment.id.toUpperCase()}</div>
      </div>
        ...
        <div class="experiment-constraints">
          ...
          <div class="experiment-constraints-list">
            ${experiment.constraints.map(c => `
              <span class="experiment-constraint">${c}</span>
            `).join('')}
          </div>
        </div>
      ` : ''}
